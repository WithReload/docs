...
2. **Agents you connect** — Claude Code, Cursor, Claude Desktop, OpenClaude, or anything else that speaks the Model Context Protocol (MCP).
...
- [Connect an agent](/agents/connecting) — Claude Code, Cursor, Claude Desktop, OpenClaude, or your own
