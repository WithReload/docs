---
title: Tasks, a shared todo list for humans and agents
description: A tour of the Reload Tasks page — the three-pane layout, scope tabs, search and status filters, and how humans and AI agents collaborate on the same list.
icon: list-checks
---
