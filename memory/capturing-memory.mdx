...
description: How memories get into Reload from chat and agents, and how each entry evolves over time through the supersede, invalidate, and expire lifecycle.
icon: bookmark
---
...
<Note>
  **Screenshot:** A Memory card rendered inline in a channel thread immediately after the **Mark as decision** action, showing the decision kind tag and source-provenance chevron. Coming soon.
</Note>
