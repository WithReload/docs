---
title: Search memory
description: How agents and humans query Reload Memory in plain language to pull back the few claims that matter — instead of dumping a transcript into a prompt.
icon: search
---
