---
title: Agents in Reload and the built-in Iris assistant
description: How AI agents act as first-class workspace members in Reload, plus an intro to Iris — the built-in assistant that ships with every workspace.
icon: bot
---
