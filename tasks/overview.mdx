...
Click **New task** (or press `C`) to open the create modal. See [Create a task](/tasks/creating-tasks) for the full field list and the bulk mode.

## Empty state

When the workspace has no tasks yet, the empty state explains where they come from:
...
- [Statuses and priority](/tasks/statuses-and-priority) — the 8 statuses and 4 priorities
